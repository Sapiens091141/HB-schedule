...
- **การนับสถิติยุบตามชื่อชีท เอาสถานะครั้งล่าสุด** (`sheetsByName()`) — ชีทเดียวกันเรียนได้หลายคาบ ถ้านับทุกครั้งที่ปรากฏ ชีทที่คาบแรกวิดิโอยังไม่จบแต่คาบหลังจบแล้วจะถูกนับเป็น 2 คลิป และยังโผล่ในรายการค้างทั้งที่ดูจบไปแล้ว · เลขหน้าโจทย์ก็เอาค่าล่าสุด (เป็นความคืบหน้าสะสมของชีทนั้น ไม่ใช่งานรายคาบ) · ส่วน "เข้าเรียนกี่ครั้ง" กับ "รวมชั่วโมง" ยังรวมทุกคาบตามเดิม
