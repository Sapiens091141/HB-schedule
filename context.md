...
- **ติดตามวิดิโอค้าง** (`pendingVideos()`) — ชีทที่สถานะล่าสุดยังไม่ติ๊ก จะโผล่ 2 ที่: ป้าย **"⏳ วิดิโอค้าง N"** บนหัวการ์ดในแท็บบันทึก (hover ดูชื่อชีทได้) และกล่องเหลือง **"⏳ ยังดูวิดิโอไม่จบ: ..."** ในภาพสรุป · ป้าย "วิดิโอยังไม่จบ" เปลี่ยนจากสีเทาเป็นสีเหลืองเตือน เพราะสีเทามองข้ามง่าย
